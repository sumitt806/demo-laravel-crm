...
class Install extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sam-crm:install';
    ...
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for SAM CRM kickstart...');
        ...
        $this->info('The installation has been finished and you can now use SAM CRM.');
    ...
    {
        $dbName = $this->ask('What is the database name to be used by SAM CRM ?');
