(function() {
    ...
    var scriptTag = document.currentScript || document.getElementById('sam_' + webFormId);
    ...
    content.innerHTML = '<div id="sam-content-container-' + webFormId + '" class="sam-content-container sam_' + webFormId + '">' + formHTML + '</div>';
    ...
    script.onload = function() {
        ...
        $('.button-group button').on('click', function() {
            data = $("#samWebForm").serializeArray();
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var validator = $("#samWebForm").validate();
