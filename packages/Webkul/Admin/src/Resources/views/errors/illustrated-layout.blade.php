            ...
            <div class="center-box">
                ...
                <div class="adjacent-center">
                    ...
                    <div class="brand-logo">
                        <img src="{{ asset('vendor/webkul/admin/assets/images/samlogo.svg') }}" alt="{{ config('app.name') }}"/>
                    </div>
                    ...
                    <div class="quick-links">
                        <ul>
                            ...
                            <li><a href="mailto: support@samcrm.com">{{ __('Contact sam Team') }}</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="copyright">
                        ...
                        <p>© Copyright 2021 <a href="https:samcrm.com">sam</a>, All right reserved.</p>
                    </div>
